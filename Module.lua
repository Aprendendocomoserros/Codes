...
function LastOneHub.new(title)
    ...
    self.Main = create("Frame", { Parent = self.Gui, Size = UDim2.new(0, 500, 0, 350), Position = UDim2.new(0.5, -250, 0.5, -175), BackgroundColor3 = Color3.fromRGB(40, 40, 40), ClipsDescendants = true })

    local top = create("Frame", { Parent = self.Main, Size = UDim2.new(1, 0, 0, 30), BackgroundColor3 = Color3.fromRGB(30, 30, 30) })
    create("TextLabel", { Parent = top, Text = title or "LastOneHub", Size = UDim2.new(1, -40, 1, 0), Position = UDim2.new(0, 10, 0, 0), TextColor3 = Color3.new(1, 1, 1), BackgroundTransparency = 1, TextXAlignment = Enum.TextXAlignment.Left })

    local closeBtn = create("TextButton", { Parent = top, Text = "X", Size = UDim2.new(0, 30, 1, 0), Position = UDim2.new(1, -30, 0, 0), BackgroundColor3 = Color3.fromRGB(170, 0, 0), TextColor3 = Color3.new(1, 1, 1) })
        ...
        for i=1,excess do
            ...
            if old and old.Frame then
                ...
                task.delay(0.38,function()
                    if old.Frame and old.Frame.Destroy then pcall(function() old.Frame:Destroy() end) end
                end)
            end
        end
